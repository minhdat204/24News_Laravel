    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img src="client/images/logo.png" alt="img" class="fh5co_logo_width" />
            </div>
            <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                ...
                <!--<div class="d-inline-block text-center"><img src="client/images/country.png" alt="img" class="fh5co_country_width"/></div>-->
...
<div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
    <div class="container padding_786">
        <nav class="navbar navbar-toggleable-md navbar-light ">
            ...
            <a class="navbar-brand" href="#"><img src="client/images/logo.png" alt="img"
                    class="mobile_logo_width" /></a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{ route('24new.index') }}">Home <span
                                class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('24new.blog') }}">Blog <span
                                class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('24new.single') }}">Single <span
                                class="sr-only">(current)</span></a>
                    </li>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('24new.contact') }}">Contact <span
                                class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
